...
function sign(e, t) {
  ...
  for (var pr = 0; ; ) {
      ...
      case "5":
          ...
          continue;
      case "6":
          var vr = ur[cr(V, 1433)]("undefined" == typeof window ? "undefined" : (0,
          esm_typeof.Z)(window), ur[cr(1640, M)]) ? window : window;
          continue;
      case "7":
          ur[cr(1587, G)]((0,
          esm_typeof.Z)(vr), ur[cr(z, 1531)]) && vr && vr[cr(q, Y) + "or"] && vr[cr(1417, Z) + "or"][cr(K, 1250) + "nt"] && vr[cr(X, J)] && (dr = ur[cr(Y, Q)]);
          continue;
      case "8":
          var yr = (new Date)[cr(ee, te)]();
          continue;
      case "9":
        const md5Str = CryptoJS.MD5([yr, dr, e, hr ? JSON[cr(ae, se) + "fy"](t) : ""][cr(ue, le)]("")).toString()
        return {
            "X-s": ur[cr(re, ne)](mr, md5Str),
            "X-t": yr
        }
      }
      break
